...
import 'package:awesome_bottom_bar/widgets/inspired/stack.dart' as extend;
...
class _InspiredState extends State<Inspired> with TickerProviderStateMixin {
  ...
  Widget buildItem(BuildContext context,
    ...
    if (widget.fixed ? widget.fixedIndex == index : active) {
      ...
      return buildContentItem(item, itemColor(), 30, widget.sizeInside!);
    }
    return Container(
      ...
      child: Column(
        ...
        children: [
          BuildIcon(
            item: item,
            iconColor: (active ? widget.titleStyle?.color : widget.color) ??
                itemColor(),
